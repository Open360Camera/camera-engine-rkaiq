...
void RKAiqMedia::GetIspSubDevs(int id, struct media_device* device, const char* devpath)
{
    ...
    entity = media_get_entity_by_name(device, "rkisp_fbcpath", strlen("rkisp_fbcpath"));
    if (entity)
    {
        entity_name = media_entity_get_devname(entity);
        if (entity_name)
...
void RKAiqMedia::GetCifSubDevs(int id, struct media_device* device, const char* devpath)
{
    ...
    entity = media_get_entity_by_name(device, "rkcif_tools_id0", strlen("rkcif_tools_id0"));
    if (entity)
    {
        entity_name = media_entity_get_devname(entity);
        if (entity_name)
    ...
    entity = media_get_entity_by_name(device, "rkcif_tools_id1", strlen("rkcif_tools_id1"));
    if (entity)
    {
        entity_name = media_entity_get_devname(entity);
        if (entity_name)
    ...
    entity = media_get_entity_by_name(device, "rkcif_tools_id2", strlen("rkcif_tools_id2"));
    if (entity)
    {
        entity_name = media_entity_get_devname(entity);
        if (entity_name)
    ...
    entity = media_get_entity_by_name(device, "rkcif-mipi-luma", strlen("rkcif-mipi-luma"));
    if (entity)
    {
        entity_name = media_entity_get_devname(entity);
        if (entity_name)
